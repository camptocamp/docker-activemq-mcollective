...
# Create keystore
keytool -importkeystore -destkeystore /opt/activemq/conf/keystore.jks -srckeystore /tmp/activemq.p12 -srcstoretype PKCS12 -alias ${certname} -deststorepass secret -srcstorepass secret
